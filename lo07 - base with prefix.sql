...
CREATE TABLE IF NOT EXISTS `lo07_cursus` (
...
CREATE TABLE IF NOT EXISTS `lo07_cursus_element` (
...
CREATE TABLE IF NOT EXISTS `lo07_element` (
...
CREATE TABLE IF NOT EXISTS `lo07_etudiant` (
...
CREATE TABLE IF NOT EXISTS `lo07_reglement` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `nom` varchar(255) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `lo07_reglement_element` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
